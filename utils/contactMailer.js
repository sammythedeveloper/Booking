    ...
    <div style="width: 100%; max-width: 900px; margin: 0 auto; background-color: #ffffff; border-radius: 16px; overflow: hidden; box-shadow: 0 4px 20px rgba(0, 0, 0, 0.1);">
        ...
        <div style="padding: 40px 30px; background-color: #ffffff;">
            ...
            <div style="text-align: center;">
                <a href="https://stayIndulgent.onrender.com/listings" style="display: inline-block; padding: 15px 30px; background: linear-gradient(135deg, #fe424d 0%, #ff7b54 100%); color: white; font-size: 18px; text-decoration: none; border-radius: 50px; font-weight: bold; box-shadow: 0 4px 10px rgba(254, 66, 77, 0.3);">Explore Our Listings</a>
            </div>
        ...
        <div style="background-color: #f4f4f4; text-align: center; padding: 30px 20px; border-top: 1px solid #e1e1e1;">
            ...
            <p style="font-size: 14px; color: #777777; margin-bottom: 20px;">If you have any additional questions, please don't hesitate to <a href="mailto:stayIndulgent247@gmail.com" style="color: #fe424d; text-decoration: none;">contact us</a>.</p>
        </div>
    </div>
</body>
</html>
